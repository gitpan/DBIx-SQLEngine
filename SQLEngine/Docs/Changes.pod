...
class as an alternate way of addressing an issue raised by another patch.
...
2001-06-27 Renamed from Adaptor to SQLEngine. Flattened class
hierarchy; we're only going to support DBI. Expunged old code.
Switched to new Class::MakeMethods distribution.
